...
erDiagram
    ...
    RepositoryBranch ||--o{ BranchGenerationTask : generates
    Repository ||--o{ GraphifyArtifact : produces
    Repository ||--o{ RepositoryGenerationLock : locks
