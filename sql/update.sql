...
CREATE TABLE "ChatAssistantConfigs" (
    ...
    "EnableImageUpload" boolean NOT NULL,
    "CreatedAt" timestamp with time zone NOT NULL,
    "UpdatedAt" timestamp with time zone,
    "DeletedAt" timestamp with time zone,
    "IsDeleted" boolean NOT NULL,
...
CREATE TABLE "ChatShareSnapshots" (
    "Id" uuid NOT NULL,
    "ShareId" character varying(100) NOT NULL,
    ...
    "IsDeleted" boolean NOT NULL,
    "Version" bytea,
    CONSTRAINT "PK_ChatShareSnapshots" PRIMARY KEY ("Id")
);
...
CREATE TABLE "Repositories" (
    ...
    "LastUpdateCheckAt" timestamp with time zone,
    "CreatedAt" timestamp with time zone NOT NULL,
    "UpdatedAt" timestamp with time zone,
    "DeletedAt" timestamp with time zone,
    "IsDeleted" boolean NOT NULL,
...
CREATE INDEX "IX_ChatShareSnapshots_ExpiresAt" ON "ChatShareSnapshots" ("ExpiresAt");

CREATE UNIQUE INDEX "IX_ChatShareSnapshots_ShareId" ON "ChatShareSnapshots" ("ShareId");
...
VALUES ('20260212195105_Initial', '10.0.2');
